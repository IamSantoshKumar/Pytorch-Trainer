...
class Model(nn.Module):
    ...
    def train_one_epoch(self, dataloader):
        ...
        for idx, data in enumerate(tk0):
            ...
            tk0.set_postfix(loss=losses.avg, accuracy_score=acc.avg, stage='train')
        tk0.close()
        return losses.avg
    ...
    def validate_one_epoch(self, dataloader):
        ...
        for idx, data in enumerate(tk0):
            ...
            losses.update(loss.item(), dataloader.batch_size)
            acc.update(accuracy.item())
            tk0.set_postfix(loss=losses.avg, accuracy_score=acc.avg, stage='valid')
        tk0.close()
        return losses.avg
    ...
    def fit(
        ...
        callbacks = runner.CallbackRunner(callback) 
        ...
        for epoch in range(epochs):
            ...
            callbacks('on_epoch_end', valid_loss, self)
            if self.flag:
                break